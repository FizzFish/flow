...
public class SetEdgePath private constructor(
    node: Unit,
    heapObject: IValue,
    ...
    public override fun equivHashCode(): Int {
        var result: Int = this.hash ?: run {
            val newHash = 31 * (31 * (31 * (31 * (31 * (31 * (31 * System.identityHashCode(this.getNode()) + this.heapObject.hashCode()) + this.heapObjectPath.hashCode()) + this.mt.hashCode()) + (this.key?.hashCode() ?: 0)) + this.value.hashCode()) + this.valuePath.hashCode()) + (this.info?.hashCode() ?: 0)
            this.hash = newHash
            newHash
        }
        return result
    ...
    public companion object {
        public fun v(
            ...
            return IPath.Companion.getInterner(SetEdgePath(env.getNode(), heapObject, heapObjectPath, mt, key, v, value, info))
        }
    }
}