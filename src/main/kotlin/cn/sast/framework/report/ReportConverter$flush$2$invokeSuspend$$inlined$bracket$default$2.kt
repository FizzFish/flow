...
internal class `ReportConverter$flush$2$invokeSuspend$$inlined$bracket$default$2` : Function0<Object> {
   fun `ReportConverter$flush$2$invokeSuspend$$inlined$bracket$default$2`(`$startTime`: LocalDateTime, `$msg`: java.lang.String, `$res`: ObjectRef) {
