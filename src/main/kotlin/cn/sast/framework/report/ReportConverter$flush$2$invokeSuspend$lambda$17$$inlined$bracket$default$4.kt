...
internal class `ReportConverter$flush$2$invokeSuspend$lambda$17$$inlined$bracket$default$4` : Function0<Object> {
   fun `ReportConverter$flush$2$invokeSuspend$lambda$17$$inlined$bracket$default$4`(
