...
internal class `SarifDiagnosticsCopySrc$close$$inlined$bracket$default$2` : Function0<Object> {
   fun `SarifDiagnosticsCopySrc$close$$inlined$bracket$default$2`(`$startTime`: LocalDateTime, `$msg`: java.lang.String, `$res`: ObjectRef) {
