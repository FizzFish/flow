...
internal class `SarifDiagnosticsPack$close$$inlined$bracket$default$4` : Function0<Object> {
   fun `SarifDiagnosticsPack$close$$inlined$bracket$default$4`(`$startTime`: LocalDateTime, `$msg`: java.lang.String, `$t`: java.lang.Throwable) {
