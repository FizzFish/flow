...
internal class `ProjectFileLocator$update$1$invokeSuspend$$inlined$bracket$default$5` : Function0<Object> {
   fun `ProjectFileLocator$update$1$invokeSuspend$$inlined$bracket$default$5`(`$startTime`: LocalDateTime, `$msg`: java.lang.String, `$res`: ObjectRef) {
