...
internal class `ProjectFileLocator$update$1$invokeSuspend$$inlined$bracket$default$2` : Function0<Object> {
   fun `ProjectFileLocator$update$1$invokeSuspend$$inlined$bracket$default$2`(`$startTime`: LocalDateTime, `$msg`: java.lang.String, `$res`: ObjectRef) {
