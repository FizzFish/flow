...
internal class `ReportConverter$flush$2$invokeSuspend$$inlined$bracket$default$4` : Function0<Object> {
   fun `ReportConverter$flush$2$invokeSuspend$$inlined$bracket$default$4`(`$startTime`: LocalDateTime, `$msg`: java.lang.String, `$t`: java.lang.Throwable) {
