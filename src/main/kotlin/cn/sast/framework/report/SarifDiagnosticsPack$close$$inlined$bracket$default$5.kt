...
internal class `SarifDiagnosticsPack$close$$inlined$bracket$default$5` : Function0<Object> {
   fun `SarifDiagnosticsPack$close$$inlined$bracket$default$5`(`$startTime`: LocalDateTime, `$msg`: java.lang.String, `$res`: ObjectRef) {
