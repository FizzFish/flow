...
internal class `SarifDiagnosticsPack$close$$inlined$bracket$default$2` : Function0<Object> {
   fun `SarifDiagnosticsPack$close$$inlined$bracket$default$2`(`$startTime`: LocalDateTime, `$msg`: java.lang.String, `$res`: ObjectRef) {
