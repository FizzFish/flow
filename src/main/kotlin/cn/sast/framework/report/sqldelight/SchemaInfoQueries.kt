...
public class SchemaInfoQueries(driver: SqlDriver) : TransacterImpl(driver) {
    ...
    @JvmStatic
    fun selectAll$lambda$0(`$mapper`: Function2<String, String, Any>, cursor: SqlCursor): Any {
    ...
    @JvmStatic
    fun selectAll$lambda$1(key: String, value_: String): SchemaInfo {
        return SchemaInfo(key, value_)
    }

    @JvmStatic
    fun insert$lambda$2(`$SchemaInfo`: SchemaInfo, `$this$execute`: SqlPreparedStatement) {
