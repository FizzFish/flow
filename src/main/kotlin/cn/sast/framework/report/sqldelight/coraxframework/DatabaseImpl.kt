...
private class DatabaseImpl(driver: SqlDriver) : TransacterImpl(driver), Database {
    override val absoluteFilePathQueries: AbsoluteFilePathQueries
    override val analyzeResultFileQueries: AnalyzeResultFileQueries
    override val analyzerStatisticsQueries: AnalyzerStatisticsQueries
    override val controlFlowQueries: ControlFlowQueries
    override val controlFlowPathQueries: ControlFlowPathQueries
    override val diagnosticQueries: DiagnosticQueries
    override val diagnosticExtQueries: DiagnosticExtQueries
    override val fileQueries: FileQueries
    override val macroExpansionQueries: MacroExpansionQueries
    override val noteQueries: NoteQueries
    override val noteExtQueries: NoteExtQueries
    override val notePathQueries: NotePathQueries
    override val regionQueries: RegionQueries
    override val ruleQueries: RuleQueries
    override val ruleMappingQueries: RuleMappingQueries
    override val ruleSetInfoQueries: RuleSetInfoQueries
    override val schemaInfoQueries: SchemaInfoQueries

    init {
        absoluteFilePathQueries = AbsoluteFilePathQueries(driver)
        analyzeResultFileQueries = AnalyzeResultFileQueries(driver)
        analyzerStatisticsQueries = AnalyzerStatisticsQueries(driver)
        controlFlowQueries = ControlFlowQueries(driver)
        controlFlowPathQueries = ControlFlowPathQueries(driver)
        diagnosticQueries = DiagnosticQueries(driver)
        diagnosticExtQueries = DiagnosticExtQueries(driver)
        fileQueries = FileQueries(driver)
        macroExpansionQueries = MacroExpansionQueries(driver)
        noteQueries = NoteQueries(driver)
        noteExtQueries = NoteExtQueries(driver)
        notePathQueries = NotePathQueries(driver)
        regionQueries = RegionQueries(driver)
        ruleQueries = RuleQueries(driver)
        ruleMappingQueries = RuleMappingQueries(driver)
        ruleSetInfoQueries = RuleSetInfoQueries(driver)
        schemaInfoQueries = SchemaInfoQueries(driver)
    }

    object Schema : SqlSchema<Value<Unit>> {
        ...
        override fun migrate(driver: SqlDriver, oldVersion: Long, newVersion: Long, vararg callbacks: AfterVersion): Value<Unit> {
            return QueryResult.Unit
        }
    }
}