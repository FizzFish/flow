...
public data class BugPathEventEnvironment(public val sootInfoCache: SootInfoCache?) {
    ...
    public fun copy(sootInfoCache: SootInfoCache? = this.sootInfoCache): BugPathEventEnvironment {
        return BugPathEventEnvironment(sootInfoCache)
    }
    ...
    public override operator fun equals(other: Any?): Boolean {
        if (this === other) {
            ...
            return this.sootInfoCache == other.sootInfoCache
        }
    }
}