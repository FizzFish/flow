...
public interface IncrementalAnalyzeByChangeFiles : IncrementalAnalyze {
    public val simpleDeclAnalysisDependsGraph: SimpleDeclAnalysisDependsGraph
    public val interProceduralAnalysisDependsGraph: InterProceduralAnalysisDependsGraph
    ...
    public interface InterProceduralAnalysisDependsGraph : IDependsGraph {
        public abstract fun update(cg: CallGraph)
    }

    public interface SimpleDeclAnalysisDependsGraph : IDependsGraph
}