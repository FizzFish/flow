...
internal class `FySastCli$special$$inlined$check$default$1` : Lambda, Function2<OptionTransformContext, java.util.List<? extends java.lang.String>, Unit> {
   fun `FySastCli$special$$inlined$check$default$1`() {
      super(2);
   }
