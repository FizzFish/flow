...
internal class `UtilsCli$special$$inlined$versionOption$default$1` : Lambda, Function1<OptionTransformContext, Unit> {
   fun `UtilsCli$special$$inlined$versionOption$default$1`(`$version`: java.lang.String, var2: CliktCommand) {
      super(1);
