...
internal class `FySastCli$special$$inlined$convert$default$8`
   ...
   fun `FySastCli$special$$inlined$convert$default$8`(`$receiver`: OptionWithValues) {
      super(2);
...
internal fun <InT : Any, ValueT : Any> OptionCallTransformContext.`<anonymous>`(it: String): ValueT {
      try {
         return new Gson()
            .fromJson(
               FilesKt.readText$default(this.$this_convert.getTransformValue().invoke(`$this$null`, it) as File, null, 1, null),
               (new TypeToken<java.util.List<? extends java.lang.String>>() {}).getType()
            ) as MutableList<java.lang.String>;
