...
internal class `FySastCli$special$$inlined$convert$default$10` : Lambda, Function2<OptionCallTransformContext, java.lang.String, Charset> {
   fun `FySastCli$special$$inlined$convert$default$10`(`$receiver`: OptionWithValues) {
      super(2);
...
internal fun <InT : Any, ValueT : Any> OptionCallTransformContext.`<anonymous>`(it: String): ValueT {
      try {
         return Charset.forName(this.$this_convert.getTransformValue().invoke(`$this$null`, it) as java.lang.String);
