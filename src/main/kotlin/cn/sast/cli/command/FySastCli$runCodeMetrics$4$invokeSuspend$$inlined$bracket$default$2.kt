...
internal class `FySastCli$runCodeMetrics$4$invokeSuspend$$inlined$bracket$default$2` : Function0<Object> {
   fun `FySastCli$runCodeMetrics$4$invokeSuspend$$inlined$bracket$default$2`(`$startTime`: LocalDateTime, `$msg`: java.lang.String, `$res`: ObjectRef) {
