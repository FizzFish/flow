...
internal class `FySastCli$special$$inlined$check$default$2` : Lambda(), Function2<OptionTransformContext, List<String>, Unit> {
    constructor() : super(2)
    ...
    internal fun <AllT, EachT, ValueT> OptionTransformContext.`<anonymous>`(it: AllT) {
        if (it != null) {
            ...
            if (it is List<*> && (it as Collection<*>).isEmpty()) {
                var10000 = true
            } else {
                label42@ {
