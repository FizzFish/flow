...
internal class `FySastCli$runCodeMetrics$4$invokeSuspend$$inlined$bracket$default$5` : Function0<Object> {
   fun `FySastCli$runCodeMetrics$4$invokeSuspend$$inlined$bracket$default$5`(`$startTime`: LocalDateTime, `$msg`: java.lang.String, `$res`: ObjectRef) {
