...
internal class `FySastCli$runCodeMetrics$4$invokeSuspend$$inlined$bracket$default$4` : Function0<Object> {
   fun `FySastCli$runCodeMetrics$4$invokeSuspend$$inlined$bracket$default$4`(`$startTime`: LocalDateTime, `$msg`: java.lang.String, `$t`: java.lang.Throwable) {
