...
internal class `FySastCli$special$$inlined$convert$default$4` : Lambda, Function2<OptionCallTransformContext, java.lang.String, IResDirectory> {
   fun `FySastCli$special$$inlined$convert$default$4`(`$receiver`: OptionWithValues) {
      super(2);
...
internal fun <InT : Any, ValueT : Any> OptionCallTransformContext.`<anonymous>`(it: String): ValueT {
      try {
         return Resource.INSTANCE.dirOf(this.$this_convert.getTransformValue().invoke(`$this$null`, it) as java.lang.String);
