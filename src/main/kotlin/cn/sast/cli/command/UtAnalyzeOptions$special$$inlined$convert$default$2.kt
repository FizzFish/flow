...
@SourceDebugExtension(["SMAP\nConvert.kt\nKotlin\n*S Kotlin\n*F\n+ 1 Convert.kt\ncom/github/ajalt/clikt/parameters/options/OptionWithValuesKt__ConvertKt$convert$valueTransform$1\n+ 2 UtAnalyzeOptions.kt\ncn/sast/cli/command/UtAnalyzeOptions\n+ 3 fake.kt\nkotlin/jvm/internal/FakeKt\n*L\n1#1,164:1\n12#2:165\n1#3:166\n*E\n"])
internal class `UtAnalyzeOptions$special$$inlined$convert$default$2` : Lambda, Function2<OptionCallTransformContext, java.lang.String, java.lang.Boolean> {
   fun `UtAnalyzeOptions$special$$inlined$convert$default$2`(`$receiver`: OptionWithValues) {
      super(2);
