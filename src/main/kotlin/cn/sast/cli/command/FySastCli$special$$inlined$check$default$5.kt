...
internal class `FySastCli$special$$inlined$check$default$5` : Lambda, Function2<OptionTransformContext, Integer, Unit> {
   fun `FySastCli$special$$inlined$check$default$5`() {
      super(2);
   }
...
internal fun <AllT, EachT, ValueT> OptionTransformContext.`<anonymous>`(it: AllT) {
      if (it != null) {
         val itx: Int = (it as java.lang.Number).intValue();
         if (1 > itx || itx >= 3) {
